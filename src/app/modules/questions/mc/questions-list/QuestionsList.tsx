        ...
        <div className='welcome-content'>
          ...
          <div className='welcome-actions'>
            <button 
              ...
              onClick={() => window.location.href = '/questions/mc/create'}
            >
        ...
        {showTagFilter && (
          <div className='tag-filter-section mt-3 d-flex justify-content-end'>
            <div className='d-flex align-items-center gap-3 flex-wrap'>
              <div className='d-flex align-items-center gap-2'>
                <label htmlFor='mc-tag-filter' className='form-label mb-0 text-white-50' style={{ fontSize: '0.875rem' }}>Tags:</label>
              ...
              <div className='d-flex align-items-center gap-2'>
                ...
                <div className='btn-group btn-group-sm' role='group'>
                  ...
                  />
                  <label className={clsx('btn btn-sm', selectedLogic === 'and' ? 'btn-light-primary' : 'btn-outline-light')} htmlFor='mcTagLogicAnd'>
                    AND
                  </label>
                  <input
                    type='radio'
                  ...
                  />
                  <label className={clsx('btn btn-sm', selectedLogic === 'or' ? 'btn-light-primary' : 'btn-outline-light')} htmlFor='mcTagLogicOr'>
                    OR
                  </label>
                </div>
              </div>
