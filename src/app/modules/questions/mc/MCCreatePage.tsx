...
const mcCreateBreadcrumbs: Array<PageLink> = [
  {
    title: 'Questions',
    path: '/questions',
    isSeparator: false,
...
const MCCreatePage: FC = () => {
  ...
  const formik = useFormik<MCFormData>({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        // Navigate to edit page with the newly created question ID
        console.log(createdQuestion.q_id)
  ...
  if (loading) {
    return (
      <>
        <PageTitle breadcrumbs={mcCreateBreadcrumbs}>Create Multiple Choice Question</PageTitle>
        <KTCard>
    ...
    <>
      ...
      <KTCard>
        <div className='card-header'>
          <h3 className='card-title'>Create New Multiple Choice Question</h3>
        </div>
